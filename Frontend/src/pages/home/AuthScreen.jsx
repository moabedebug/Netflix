  ...
  return (
    <div className="hero-bg relative">
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto" >
          <h1 className="text-4xl md:text-6xl font-bold mb-4" > Filmes Ilimitados, Séries e mais</h1>
      ...
      <div className='py-10 bg-black text-white'>
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:py-2">
          <div className="flex-1 text-center md:text-left ">
            <h2 className="text-4xl md:text-5xl font-extrabold mb-4">Aproveite na sua TV</h2>
            <p className="text-lg md:text-xl">
              Assista em Smart TVs, PlayStation, Xbox, Chromecast, Apple TV, Blu-ray players e mais.
            </p>
          </div>
      ...
      <div className="h-2 w-full bg-[#232323]" aria-hidden='true'/>
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:py-2">
          ...
          <div className="flex-1 md:text-left text-center">
            ...
            <p className="text-lg md:text-xl">
              Salve seus programas favoritos e sempre tenha algo para assistir
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            espaço feito especialmente para elas - grátis com sua assinatura
            </p>
          </div>
        </div>
      </div>
